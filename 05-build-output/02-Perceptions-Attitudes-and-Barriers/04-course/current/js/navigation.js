...
(function(){
  ...
  var interactiveSlides = {
    10: 'scenario',  // Scenario 1: Assumptions About Ability
    11: 'scenario',  // Scenario 2: Implicit Bias at Work
    12: 'scenario',  // Scenario 3: Cultural Misunderstanding
    13: 'scenario',  // Scenario 4: Mental Health Handoff
    14: 'kc',        // KC1: Implicit bias definition
    15: 'kc',        // KC2: Spread effect
    16: 'kc',        // KC3: OHRC paternalism
    18: 'reflection', // Reflection prompt
  };
  ...
  if (reflectBtn) {
    reflectBtn.addEventListener('click', function(e) {
      ...
      try {
        localStorage.setItem('guide02_reflection', text);
      } catch(ex) {}
      // Visual confirmation
  ...
  var menuSlides = [
    {n:1, name:'Welcome', screen:'2.1'},
    {n:2, name:'Learning Objectives', screen:'2.2'},
    {n:3, name:'Why This Matters: The Stat', screen:'2.3'},
    {n:4, name:'Impact: Attitudinal Barriers', screen:'2.4'},
    {n:5, name:'Impact: Stigma & Mental Health', screen:'2.5'},
    {n:6, name:'Impact: Intersectionality', screen:'2.6'},
    {n:7, name:'Implicit vs. Explicit Bias', screen:'2.7'},
    {n:8, name:'Attitudinal Barriers Framework', screen:'2.8'},
    {n:9, name:'Reflective Practice Model', screen:'2.9'},
    {n:10, name:'Scenario 1: Assumptions About Ability', screen:'2.10'},
    {n:11, name:'Scenario 2: Implicit Bias at Work', screen:'2.11'},
    {n:12, name:'Scenario 3: Cultural Misunderstanding', screen:'2.12'},
    {n:13, name:'Scenario 4: Mental Health Handoff', screen:'2.13'},
    {n:14, name:'Knowledge Check 1', screen:'2.14'},
    {n:15, name:'Knowledge Check 2', screen:'2.15'},
    {n:16, name:'Knowledge Check 3', screen:'2.16'},
    {n:17, name:'Inclusive Practice Tips', screen:'2.17'},
    {n:18, name:'Reflection Prompt', screen:'2.18'},
    {n:19, name:'MAP Action Planning', screen:'2.19'},
    {n:20, name:'Key Takeaways', screen:'2.20'},
    {n:21, name:'Listen & Reflect (Podcast)', screen:'2.21'},
    {n:22, name:'Series Progress Map', screen:'2.22'},
    {n:23, name:'Resources & Completion', screen:'2.23'},
  ];
