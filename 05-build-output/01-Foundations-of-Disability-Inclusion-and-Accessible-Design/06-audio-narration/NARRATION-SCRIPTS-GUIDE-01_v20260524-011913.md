# Narration Scripts — Guide 01: Foundations of Disability Inclusion and Accessible Design

## Production Information

- **Course Series:** UHN Accessibility First (Guide 1 of 18)
- **Voice Style:** Warm, professional, conversational. Canadian English pronunciation.
- **Reading Level:** Grade 8-10 (plain language)
- **Pacing:** 150 words per minute
- **Target Duration per Screen:** 30-90 seconds narration
- **Person:** Second person ("you") — speaking directly to the learner
- **Date:** 2026-05-23
...
[WORD COUNT: 142 | ESTIMATED TIME: 57 seconds]

---

## [SCREEN 1.2 — Learning Objectives]

(Beat — clear, structured tone)
...
[WORD COUNT: 117 | ESTIMATED TIME: 47 seconds]
...
(Beat — teaching tone, clear and measured)
...
[WORD COUNT: 195 | ESTIMATED TIME: 78 seconds]

---

## [SCREEN 1.5 — Accessibility in Practice Model]

(Beat — structured, guiding tone)
...
[WORD COUNT: 189 | ESTIMATED TIME: 76 seconds]

---

## [SCREEN 1.6 — Accessibility Decision Path]

(Beat — encouraging, practical tone)

When you encounter a situation involving accessibility, what do you actually do? That is where the Accessibility Decision Path comes in. This is a five-step framework you can use in any moment.
...
[WORD COUNT: 190 | ESTIMATED TIME: 76 seconds]

---

## [SCREEN 1.7 — Scenario 1: Hospital Booking System]

(Beat — storytelling tone, drawing the learner in)
...
[WORD COUNT: 168 | ESTIMATED TIME: 67 seconds]

---

## [SCREEN 1.8 — Scenario 2: Clinic Signage]

(Beat — storytelling tone)
...
[WORD COUNT: 120 | ESTIMATED TIME: 48 seconds]

---

## [SCREEN 1.9 — Scenario 3: Employee Awareness]

(Beat — storytelling tone, thoughtful)
...
[WORD COUNT: 145 | ESTIMATED TIME: 58 seconds]

---

## [SCREEN 1.10 — Knowledge Check 1]

(Beat — supportive, clear tone)
...
[WORD COUNT: 85 | ESTIMATED TIME: 34 seconds]
...
[WORD COUNT: 58 | ESTIMATED TIME: 23 seconds]
...
[WORD COUNT: 140 | ESTIMATED TIME: 56 seconds]

---

## [SCREEN 1.14 — MAP Action Planning]

(Beat — encouraging, forward-looking tone)

Now it is time to create your My Action Plan — your MAP. This is a tool you will use in every guide throughout the series, and it travels with you.
...
[WORD COUNT: 160 | ESTIMATED TIME: 64 seconds]

---

## [SCREEN 1.15 — Key Takeaways]

(Beat — confident, summarizing tone)
...
[WORD COUNT: 175 | ESTIMATED TIME: 70 seconds]
...
[WORD COUNT: 178 | ESTIMATED TIME: 71 seconds]

---

## Total Narration Summary

| Screen | Title | Word Count | Estimated Time |
|--------|-------|------------|----------------|
...
| 1.7 | Scenario 1: Hospital Booking System | 168 | 67s |
| 1.8 | Scenario 2: Clinic Signage | 120 | 48s |
...
| **Total** | | **2,578** | **~17 min 11s** |

## Voice Direction Notes

- **Pronunciation:** Use Canadian English ("centre" not "center", "colour" not "color"). Pronounce AODA as "ay-oh-dee-ay."
- **Pacing:** Slow slightly for key terms on first introduction (e.g., "human rights model," "Accessibility Decision Path"). Normal pace for narrative sections.
- **Tone Shifts:** Warmer for scenarios, more structured for framework explanations, quieter for reflection.
- **Pauses:** Honour all (Beat) markers with a 1-2 second pause. Longer pause (2-3 seconds) before scenario choices.

## References

- Statistics Canada. (2023). *Canadian Survey on Disability, 2022*. Government of Canada.
