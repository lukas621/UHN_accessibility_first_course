...
# Load API key
env_path = Path("/Users/yijin/Documents/New Company Claude/UHN Accessibility Course/.env")
api_key = None
...
def generate_image(prompt, filename):
    ...
    payload = {
        ...
        "prompt": prompt,
        "n": 1,
        "size": "1536x1024",  # Closest to 16:9 available
        "quality": "high",
    }
    ...
    try:
        ...
        if "url" in item and item["url"]:
            ...
            print(f"  Response keys: {list(item.keys())}")
            return False
