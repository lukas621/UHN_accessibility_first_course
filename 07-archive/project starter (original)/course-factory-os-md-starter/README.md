...
Course Factory OS is an internal AI-assisted eLearning production system for instructional designers. The first pilot use case is a large accessibility-related course series with 18 course guides. The goal is to convert large SME/source materials into structured, reviewable, build-ready, accessible eLearning products.
